...
pd.read_csv(r'D:\HotelMappingCancelationPrediction\Flask\data\hotel_final.csv')
...
#generate data frame from csv
    hotel = pd.read_csv(r'D:\HotelMappingCancelationPrediction\Flask\data\hotel_final.csv')
